          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-5">
                <a
                  href="https://x.com/daniel_rol22591"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="X (Twitter)"
                  className="text-[#6b6b6b] hover:text-[#c9a84c] transition-colors duration-300"
                >
                ...
                <a
                  href="https://www.instagram.com/ialucide?igsi=NGZnZDI0YjhqNjVl&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"

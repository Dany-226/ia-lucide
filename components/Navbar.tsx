...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f4f0e8] border-b border-[#c9a84c]">
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden bg-[#f4f0e8] border-t border-[#c9a84c]/30 px-5 pb-6 pt-4 space-y-4">
          {NAV_LINKS.map((link) => (
            <Link
              key={link.href}
              href={link.href}

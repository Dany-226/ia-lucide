...
**Ce qui change côté tarifs (mise à jour septembre 2026)**

Le Compte Pro Pennylane (cartes bancaires, encaissements, financement de factures) est désormais accessible dès l'offre Starter à 7€ HT/mois, auparavant réservé aux offres supérieures. Pour un cabinet qui oriente un indépendant vers l'outil, ça change le ticket d'entrée réel.

Autre évolution : l'obligation de facturation électronique, entrée en vigueur le 1er septembre 2026 pour toutes les entreprises françaises, est couverte gratuitement par Pennylane pour les micro-entrepreneurs (0€, jusqu'à 1200 factures par an, un utilisateur) - pas besoin de payer un outil dédié uniquement pour être en conformité.

Pennylane propose aussi des terminaux de paiement physiques depuis peu, à partir de 89€ sans abonnement ni engagement. Les frais de transaction varient selon la carte : 0,75% pour les cartes bancaires classiques émises dans l'UE, 2% pour les cartes hors UE ou professionnelles, 2,5% pour Amex, avec les fonds disponibles sous 24h ouvrées sur le compte professionnel. Pour un client qui encaisse par carte, ça évite de jongler entre un terminal tiers et la compta.

[→ Découvrir Pennylane](https://c3po.link/QCPW6mXBJ6)
...
[→ Découvrir Chaintrust](https://www.chaintrust.io)
...
[→ Découvrir Dext](https://www.dext.com/fr)
...
[→ Découvrir Digits](https://www.digits.com)
...
|---|---|---|---|---|
| [**Pennylane**](https://c3po.link/QCPW6mXBJ6) | Catégorisation, rapprochement | Relation client fluide | Limité sur dossiers complexes | TPE/indépendants |
| [**Indy**](https://www.indy.fr) | Saisie côté client | Autonomie du client | Pas fait pour le cabinet | Professions libérales |
| [**Chaintrust**](https://www.chaintrust.io) | Saisie et flux documentaire | Taux d'automatisation élevé | Mise en place exigeante | Cabinets à gros volume |
| [**Dext**](https://www.dext.com/fr) | Capture et extraction | OCR de référence | Périmètre limité | Tous types |
| [**Digits**](https://www.digits.com) | Analyse et reporting | Valeur conseil | Moins implanté en France | Cabinets conseil |

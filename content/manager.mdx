...
slug: "manager"
excerpt: "Le manager n'est pas la cible principale de l'automatisation, mais il est au centre de tous les bouleversements qu'elle provoque. L'IA change sa position."
tag: "Management"
category: "metiers"
author: "digicorpex"
read_time: "7.0"
...
*Vous êtes dirigeant ou cadre supérieur ? Votre capacité à piloter la transformation de votre organisation est un actif stratégique. Mesurez votre exposition et sécurisez votre trajectoire sur [ialucide.fr](https://ialucide.fr/diagnostic-exposition-ia/).*